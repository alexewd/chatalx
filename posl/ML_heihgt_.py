...
# Словарь для хранения моделей и их гиперпараметров
param_grid = {
    'Linear Regression': {},
...
# Оптимизация гиперпараметров и оценка моделей
for name, model in models.items():
    ...
    metrics.append({'Model': name, 'Best Params': grid.best_params_, 'MSE': mse, 'R2': r2})
...
plt.scatter(X_test['Height'], models['Linear Regression'].fit(X_train, y_train).predict(X_test), color='red', label='Linear Regression Predictions', alpha=0.6)
