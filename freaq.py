...
print("Буква | Частота в тексте (%) | Ожидаемая частота (%) | Отношение к ожиданию")
print("-------------------------------------------------------------")
for letter, count in frequency.items():
    if letter.isalpha():
        ...
        if letter in russian_frequency:
            expected_frequency = russian_frequency[letter]
            ratio = round(relative_frequency / expected_frequency, 2)
            print(f"  {letter}   |        {relative_frequency_percent}       |        {expected_frequency * 100:.3f}       |      {ratio}")
