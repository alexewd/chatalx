...
logging.basicConfig(
    ...
    filemode='w'  # Перезаписываем файл, чтобы не копились старые логи
)
console = logging.StreamHandler()  # Добавляем вывод в консоль
console.setLevel(logging.INFO)
logging.getLogger('').addHandler(console)

# Путь к файлу
pdf_path = r'c:\bac_c\nekropol\1_a_b.pdf'  # Укажи полный путь, например, r'C:\Users\alexewd\Documents\your_file.pdf'
